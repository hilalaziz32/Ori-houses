...
export const SITE = {
  ...
  housesBought: "1,200+",
  themeColor: "#1F4429",
  // Registered business address, matching the GHL business profile and the entity the
  // SMS campaign is filed under. Shown in the footer and on the contact page.
  address: { street: "5830 E 2nd St", city: "Casper", region: "WY", zip: "82609", country: "US" },
  geo: { lat: "", lng: "" },
  priceRange: "$$",
